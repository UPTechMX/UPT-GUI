...
export class StEvaluationService {
  ...
  postLayer(
    saId: string,
    layersData: number[],
    publicLayersData: number[],
    filtersData: string[],
    publicFiltersData: string[],
    settingsData: string,
    publicSettingsData: string,
    id: number
  ): Observable<any> {
    try {
      ...
      return this.http
        .post<any>(
          "/action?action_route=LayersSTHandler&action=index_values",
          body
        )
  ...
  postPublicLayer(
    ...
    try {
      ...
      return this.http
        .post<any>(
          "/action?action_route=LayersSTHandler&action=public_index_values",
          body
        )
        .pipe(map((res) => res as any));
    } catch (e) {
  ...
  postStdArea(id: any): Observable<any> {
    ...
    return this.http
      .post<any>("/action?action_route=evaluate_distances", body)
      .pipe(map((res) => res as any));
  }
  ...
  statusEvaluateST(id: any): Observable<Status[]> {
    ...
    return this.http
      .get<any>("/action?action_route=evaluate_distances", httpOptions)
      .pipe(map((res) => res as Status[]));
  }
  ...
  getDistanceLayers(id: any): Observable<any[]> {
    ...
    return this.http
      .get<any>(
        "/action?action_route=evaluate_distances_new_layers",
        httpOptions
      )
      .pipe(map((res) => res as any[]));
  }
  ...
  getPublicDistanceLayers(id: any): Observable<any[]> {
    ...
    return this.http
      .get<any>(
        "/action?action_route=evaluate_public_distances_new_layers",
        httpOptions
      )
      .pipe(map((res) => res as any[]));
  }
