...
export class ScenarioService {
  ...
  public getScenarios(): Observable<Scenario[]> {
    return this.http
      .get<Scenario>("/action?action_route=up_scenario")
      .pipe(map((res) => res as Scenario[]));
  }
  ...
  public putScenario(scenario: Scenario): Observable<Scenario> {
    ...
    try {
      return this.http
        .put<any>("/action?action_route=up_scenario", body)
        .pipe(map((res) => res as Scenario));
    } catch (e) {
      console.log(e);
    }
  ...
  public deleteScenario(scenario: Scenario): Observable<Scenario> {
    ...
    try {
      return this.http
        .delete<any>("/action?action_route=up_scenario", httpOptions)
        .pipe(map((res) => res as Scenario));
    } catch (e) {
      console.log(e);
    }
  ...
  public getPublicScenarios(): Observable<Scenario[]> {
    return this.http
      .get<Scenario>("/action?action_route=up_public_scenario")
      .pipe(map((res) => res as Scenario[]));
  }
  ...
  public putPublicScenario(scenario: Scenario): Observable<Scenario> {
    ...
    try {
      return this.http
        .put<any>("/action?action_route=up_public_scenario", body)
        .pipe(map((res) => res as Scenario));
    } catch (e) {
      console.log(e);
    }
  ...
  public deletePublicScenario(scenario: Scenario): Observable<Scenario> {
    ...
    try {
      return this.http
        .delete<any>("/action?action_route=up_public_scenario", httpOptions)
        .pipe(map((res) => res as Scenario));
    } catch (e) {
      console.log(e);
    }
